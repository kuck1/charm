...
cublasSgemm(handle,CUBLAS OP N     ,CUBLAS OP N           , m,n,k,&al,d a, m,d b,k,&bet,d c,m);
cublasSsymm(handle,CUBLAS SIDE LEFT,CUBLAS FILL MODE LOWER, m,n,&al,d a,m,d b,m,&bet,d c,m);
    ...
    double *ALPHA, double *BETA, cublasHandle_t handle)
{
    ...
    cublasDsymm(handle, CUBLAS_SIDE_LEFT, CUBLAS_FILL_MODE_LOWER, m, n, ALPHA, d_X, m, d_Y, m, BETA, d_Z, m);
}
